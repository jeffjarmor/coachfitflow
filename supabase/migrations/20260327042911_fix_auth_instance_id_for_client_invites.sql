-- Backfill previously created auth users so they appear consistently in Supabase Auth UI
update auth.users
...
-- Ensure new invited users are created with a valid instance_id
...
begin
  ...
  if v_user_id is not null then
    -- Self-heal users created before instance_id fix
    update auth.users
