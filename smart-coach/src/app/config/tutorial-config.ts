    ...
    },
    {
        ...
        steps: [
            ...
            },
            {
                ...
                description: 'Elige un cliente de la lista para asignarle esta rutina.',
            ...
            },
            {
                ...
                description: 'Selecciona los días de entrenamiento y asigna grupos musculares a cada día.',
                targetSelector: '[data-tutorial="muscle-groups"]',
                position: 'bottom',
                action: 'none',
                disableNavigation: true
            },
    ...
    },
    {
        ...
        steps: [
            ...
            },
            {
                ...
                targetSelector: '.mobile-fab[data-tutorial="create-exercise-btn"], [data-tutorial="create-exercise-btn"]:not(.mobile-fab)',
                position: 'top',
                action: 'click',
                highlightPadding: 12
            }
